package co.tara.tarabari.passenger.state;
...
import co.tara.tarabari.passenger.fragment.FindDriverFragment;
import co.tara.tarabari.passenger.fragment.PriceRequestFragment;
 ...
 */
public class StateOfApp implements Serializable {
    ...
    public StateOfApp(Activity activity, FragmentManager fragmentManager, int state) {
...
*/
    ...
    public void goToStateNormal() {
        relFavoritePlace.setVisibility(View.VISIBLE);
        relselectCar.setVisibility(View.VISIBLE);
    ...
    public void goToStateGetPrice(Trip trip) {
        ...
        relFavoritePlace.setVisibility(View.GONE);
        relselectCar.setVisibility(View.GONE);
