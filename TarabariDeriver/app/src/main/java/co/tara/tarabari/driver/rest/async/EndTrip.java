...
import co.tara.tarabari.driver.rest.request.EndTripApi;
...
public class EndTrip extends AsyncTask<TripRES, Void, Object> {


    public AsyncResponse delegate = null;

    public EndTrip(AsyncResponse delegate) {
    ...
    protected Object doInBackground(TripRES... driverRES) {
        ...
        EndTripApi vehicleList = MyScalarClient.getClient().create(EndTripApi.class);
        Call<String> call = vehicleList.end(drivers, "application/json");
