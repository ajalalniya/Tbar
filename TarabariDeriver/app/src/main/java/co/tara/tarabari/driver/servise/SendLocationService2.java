...
public class SendLocationService2 extends Service implements LocationListener {
                ...
                try {
                    ...
                    SetLatLng setLatLng = new SetLatLng(new AsyncResponse() {
                        ...
                        public void processFinish(Object output) {
                            ...
                            if (tripRESArrayList != null && tripRESArrayList.size() > 0) {
                                broadcastIntent(tripRESArrayList.get(0));
                                //StateOfDriver.goToState1( Config.context,tripRESArrayList.get(0));
...
*/
    ...
    public void broadcastIntent(TripRES tripRES) {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            ...
            locationManager.removeUpdates(SendLocationService2.this);
        }
    }
