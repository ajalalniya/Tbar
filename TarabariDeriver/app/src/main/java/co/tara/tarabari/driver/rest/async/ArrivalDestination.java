...
public class ArrivalDestination extends AsyncTask<TripRES, Void, Object> {


    public AsyncResponse delegate = null;

    public ArrivalDestination(AsyncResponse delegate) {
    ...
    protected Object doInBackground(TripRES... driverRES) {
        ...
        ArrivalDestinationApi vehicleList = MyScalarClient.getClient().create(ArrivalDestinationApi.class);
        Call<String> call = vehicleList.arrive(drivers, "application/json");
